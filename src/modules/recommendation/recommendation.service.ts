...
export const RecommendationService =
	Context.GenericTag<RecommendationService>('RecommendationService')

export const RecommendationServiceLive: Layer.Layer<RecommendationService, never, GameDataLayer> =
	Layer.effect(
